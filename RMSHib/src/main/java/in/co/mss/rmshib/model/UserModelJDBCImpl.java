...
import in.co.mss.rmshib.util.EmailBuilder;
import in.co.mss.rmshib.util.EmailMessage;
import in.co.mss.rmshib.util.EmailUtility;
...
public class UserModelJDBCImpl implements UserModelInt {
	...
	public long add(UserDTO dto) throws ApplicationException,
		...
		try {
			...
			pstmt.setString(9, dto.getRoleName());
			pstmt.setInt(10, dto.getUnSuccessfulLogin());
			pstmt.setString(11, dto.getGender());
			pstmt.setTimestamp(12, dto.getLastLogin());
			pstmt.setString(13, dto.getLock());
			pstmt.setString(14, dto.getRegisteredIP());
			pstmt.setString(15, dto.getLastLoginIP());
	...
	public void update(UserDTO dto) throws ApplicationException,
		...
		try {
			...
			pstmt.setString(8, dto.getRoleName());
