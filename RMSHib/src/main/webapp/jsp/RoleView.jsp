...
<%@page import="in.co.mss.rmshib.controller.RoleCtl"%>
...
<jsp:useBean id="dto" class="in.co.mss.rmshib.dto.RoleDTO"
...
<div class="col-sm-offset-4">
	...
	<form class="form-horizontal" action="<%=ORSView.ROLE_CTL%>"
		method="post">
		...
		<div class="form-group">
			<label for="inputPassword3" class="col-sm-3 control-label">
				<div class="text-left">Description:</div></label>
			<div class="col-sm-4" style="margin-left: -145">
				<textarea class="form-control" style="width: 285px; border-width: 2px" rows="2"
		...
		<div class="col-sm-offset-2 col-sm-10">
			<button type="submit" class="btn btn-primary text-center"
				style="margin-left: -70" name="operation"
